...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (@ingredient_concept_ids)and invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (@measurement_concept_ids)and invalid_reason is null
