...
def_x_post, def_z3_post, def_z2_post, def_z1_post, def_W0_post, def_x_post_np, def_z_post_np = fit_def(x_train.T, K=[100,30,5], prior_a=0.1, prior_b=0.3, n_iter=100*n_iter, optimizer=tf.train.RMSPropOptimizer(1e-3))
...
print("DEF mse", ((G-def_x_post_np)**2).mean())
